...
<p class="lead">Add edit/delete functionality</p>
(Table: petstore)
					...
					<h2>Pet Stores</h2>
						...
						<form id="edit_petstore" method="post" class="form-horizontal" action="edit_petstore_process.php">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control maxlength="30" name="name" value="<?php echo $result['pst_name']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="30" name="street" value="<?php echo $result['pst_street']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="30" name="city" value="<?php echo $result['pst_city']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="2" name="state" value="<?php echo $result['pst_state']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="9" name="zip" value="<?php echo $result['pst_zip']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="10" name="phone" value="<?php echo $result['pst_phone']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="100" name="email" value="<?php echo $result['pst_email']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control maxlength="100" name="url" value="<?php echo $result['pst_url']; ?>" />
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="11" name="ytd_sales" value="<?php echo $result['pst_ytd_sales']; ?>" />
										</div>
								</div>
